...
export const ALL_SYSTEM_ROUTES: SystemRouteEntry[] = [
  ...
  { id: "accounting-journals", to: "/accounting/journals", label: "دفاتر اليومية", icon: "FileText", groupId: "accounting", groupLabel: "المحاسبة العامة" },
  { id: "accounting-ledger", to: "/accounting/reports/ledger", label: "دفتر الأستاذ", icon: "BarChart3", groupId: "accounting", groupLabel: "المحاسبة العامة" },
  { id: "accounting-movements", to: "/accounting/reports/movements", label: "حركات الحسابات", icon: "BarChart3", groupId: "accounting", groupLabel: "المحاسبة العامة" },
  { id: "income-statement", to: "/accounting/reports/income", label: "قائمة الدخل", icon: "DollarSign", groupId: "accounting", groupLabel: "المحاسبة العامة" },
