...
import { type CreatePaymentRequest, type PartnerDto } from "@erp/shared-types";
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 grid grid-cols-2 gap-4 p-3 bg-slate-50/50 rounded-lg border border-slate-100">
              ...
              <div className="space-y-1.5">
                <Label className="text-xs font-bold text-slate-600">إلى الحساب المدين (مسحوبات)</Label>
                <Input value={`مسحوبات ${partner.name}`} disabled className="h-9 bg-slate-50 text-slate-500 font-bold" />
              </div>
            </div>
