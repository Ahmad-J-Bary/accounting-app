...
export default function Expenses() {
  ...
  const handleSaveVoucher = async (payload: CreatePaymentRequest) => {
    try {
      ...
      await refresh(true);
      toast.success(t("expense.voucherSaveSuccess", { namespace: "invoicing",  }));
      setIsVoucherOpen(false);
    } catch (error) {
      toast.error(t("expense.voucherSaveError", { namespace: "invoicing", vars: { error: String(error) },  }));
    } finally {
  ...
  const handleExport = useCallback(async () => {
    const currCols = currencyAmountCols("balance", t("expense.balance", { namespace: "invoicing",  }), (row) => {
    ...
    await executeExport(exportData, {
      sheetName: t("expense.title", { namespace: "invoicing",  }),
      filename: t("expense.title", { namespace: "invoicing",  }),
