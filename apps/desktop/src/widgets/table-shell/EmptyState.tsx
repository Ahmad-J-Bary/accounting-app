  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        {icon || <Inbox className={cn("text-muted-foreground", compact ? "w-6 h-6" : "w-10 h-10")} />}
      </div>
      <p className={cn("font-bold text-muted-foreground", compact ? "text-sm" : "text-base")}>{resolvedMessage}</p>
      {resolvedSuggestion && (
