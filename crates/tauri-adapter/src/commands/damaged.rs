...
use application::dto::damaged_dto::{
    CreateDamagedItemRequest, DamagedItemDto, UpdateDamagedItemRequest,
};
use application::use_cases::damaged::{
    CreateDamagedItemUseCase, DamagedItemQueries, DeleteDamagedItemUseCase,
...
#[tauri::command]
pub async fn list_damaged_items(state: State<'_, AppState>) -> Result<Vec<DamagedItemDto>, String> {
...
#[tauri::command]
pub async fn delete_damaged_item(id: String, state: State<'_, AppState>) -> Result<(), String> {
