...
use domain::shared::ids::{CustomerId, InvoiceId, SupplierId};
...
pub fn row_to_invoice(
...
) -> Result<UnifiedInvoice, AppError> {
    ...
    Ok(UnifiedInvoice {
        ...
        tax_amount: MonetaryAmount {
            original: Money::new(
                Decimal::from_str(&row.tax_amount).unwrap_or(Decimal::ZERO),
                Currency::new(
                    &row.currency_code,
                    &row.currency_code,
                    &row.currency_code,
        ...
        discount_amount: MonetaryAmount {
            original: Money::new(
                Decimal::from_str(&row.discount_amount).unwrap_or(Decimal::ZERO),
                Currency::new(
                    &row.currency_code,
                    &row.currency_code,
                    &row.currency_code,
        ...
        extra_costs: MonetaryAmount {
            original: Money::new(
                Decimal::from_str(&row.extra_costs).unwrap_or(Decimal::ZERO),
                Currency::new(
                    &row.currency_code,
                    &row.currency_code,
                    &row.currency_code,
        ...
        total_amount: MonetaryAmount {
            original: Money::new(
                Decimal::from_str(&row.total_amount).unwrap_or(Decimal::ZERO),
                Currency::new(
                    &row.currency_code,
                    &row.currency_code,
                    &row.currency_code,
        ...
        amount_paid: MonetaryAmount {
            original: Money::new(
                Decimal::from_str(&row.amount_paid).unwrap_or(Decimal::ZERO),
                Currency::new(
                    &row.currency_code,
                    &row.currency_code,
                    &row.currency_code,
