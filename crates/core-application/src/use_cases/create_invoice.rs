...
use core_domain::shared::{CustomerId, ProductId, Money};
...
mod tests {
    ...
    use std::sync::Mutex;
    use core_domain::sales::invoice_line::InvoiceLine as DomainInvoiceLine;
    use core_domain::shared::Money as DomainMoney;
    ...
    impl InvoiceRepository for MockInvoiceRepository {
        ...
        async fn find_by_id(&self, _: &core_domain::shared::InvoiceId) -> Result<Option<Invoice>, AppError> {
            Ok(None)
        }
