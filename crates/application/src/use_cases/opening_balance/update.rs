...
use domain::accounting::{OpeningBalanceLine, MigrationStatus};
...
use crate::use_cases::opening_balance::types::{OpeningMigrationDto, UpdateOpeningMigrationLinesCommand};
...
impl UpdateOpeningMigrationLinesUseCase {
    ...
    pub async fn execute(&self, cmd: UpdateOpeningMigrationLinesCommand) -> Result<OpeningMigrationDto, AppError> {
